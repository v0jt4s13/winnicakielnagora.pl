...
| `zdjecie_sklep` | string | nie | opcjonalna ścieżka względna do obrazu pod `attached_assets/`, np. `butelki/nazwa.jpg`; zastępuje obraz karty sklepu (panel akceptuje też prefiks `attached_assets/` i starszy pojedynczy `/`) |
